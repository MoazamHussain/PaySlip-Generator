        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
                ...
                <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="employee.jsp">Dashboard</a></li>
    ...
    %>           
                    ...
                    <div class="col-sm-6 m-b-20">
                      <div class="invoice-details" style="text-align: end;">
                        ...
                        <li>Designation: <span><%= rs.getString(17)%></span></li>
                        </ul>
                      </div>
                    </div>
                  </div>
...
%>
  ...
  PreparedStatement stmt1=con.prepareStatement("SELECT s.s_id,s.emp_id,s.basic,s.da,s.hra,s.conveyance,s.allowance,s.medical,s.tds,s.esi,s.pf,s.leaves,s.tax,s.labour,s.net_sal FROM salary s,emp e WHERE e.emp_id="+k+" and s.emp_id="+k+"");  
